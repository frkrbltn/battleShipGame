...
public class BoardTest {
    ...
    public void testConstructorAndGetters() {
        ...
        assertEquals(0, board.getNumberOfShips(),
                "Testing current number of ships");
        assertFalse(board.hasBeenHit(0, 0),
                "Testing that (0,0) has not been hit");
    }
    ...
    public void testAddShipHorizontal() {
        ...
        assertEquals(1, board.getNumberOfShips(), "Test getNumberOfShips() after 1 ship added");
        ...
        assertFalse(board.addShip(2, true, 9, 8),
                "Add horizontal ship that will not fit in boundary.");
        assertTrue(board.addShip(2, true, 9, 7), "Add horizontal ship at edge.");
        assertFalse(board.addShip(3, true, 7, 1),
                "Add ship when max number of ships already added.");
    }
