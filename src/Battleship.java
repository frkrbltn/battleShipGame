...
public class Battleship {
    ...
    public Battleship( long seed ) {
        ...
        ai = new BattleshipAI( computerBoard, SHIP_LENGTHS, seed );
    ...
    public Battleship() {
        humanBoard = new Board(ROWS, COLS, NUMBER_OF_SHIPS);
        computerBoard = new Board(ROWS, COLS, NUMBER_OF_SHIPS);
        ai = new BattleshipAI( computerBoard, SHIP_LENGTHS );
        status = "Place " + SHIP_NAMES[0] + ", length = " + SHIP_LENGTHS[0];
    }

    /**
     * Returns the computer player's board
    ...
    /**
     * Returns the number of ships used in the game
    ...
    /**
     * Returns the length of the i-th ship
    ...
    /**
     * Returns true if all the human player's ships have been placed
    ...
    public void moveOnToNextShip() {
        ...
        if ( shipIndex < NUMBER_OF_SHIPS ) {
            ...
            status = "Done placing ships. Firing begins - fire at computer board!";
        }
