...
public class BattleshipAI {
    ...
    /**
     * Constructor
     * initializes instance variables, sets up the random number sequence based
     * on the provided seed and places the ships
    ...
    private void setUpShips(int[] shipLengths) {
        for (int i = 0; i < shipLengths.length; i++) {
            ...
            while(!successful) {
                ...
                if (computerBoard.addShip(shipLengths[i], horizontal,
                        row, col)) {
                    successful = true;
                }
            }
